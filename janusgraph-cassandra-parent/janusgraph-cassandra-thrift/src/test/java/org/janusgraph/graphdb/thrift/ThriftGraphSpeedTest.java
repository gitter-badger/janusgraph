...
public class ThriftGraphSpeedTest extends JanusGraphSpeedTest {
    ...
    public ThriftGraphSpeedTest() throws BackendException {
        super(CassandraGraphConfiguration.getConfiguration(ThriftGraphSpeedTest.class, StandardStoreManager.CASSANDRA_THRIFT).getConfiguration());
    }

    @BeforeClass
    public static void beforeClass() {
        initialiseCassandra(ThriftGraphPerformanceMemoryTest.class);
    }
