...
public class ThriftMultiWriteStoreTest extends MultiWriteKeyColumnValueStoreTest {
    ...
    public static void startCassandra() {
        initialiseCassandra(ThriftMultiWriteStoreTest.class);
    }

    @Override
    public KeyColumnValueStoreManager openStorageManager() throws BackendException {
        return new CassandraThriftStoreManager(CassandraGraphConfiguration.getConfiguration(getClass(), StandardStoreManager.CASSANDRA_THRIFT));
    }
}
