...
<#if initialToken??># </#if>num_tokens: 256

# initial_token allows you to specify tokens manually.  While you can use # it with
# vnodes (num_tokens > 1, above) -- in which case you should provide a 
# comma-separated list -- it's primarily used when adding nodes # to legacy clusters 
# that do not have vnodes enabled.
<#if initialToken??>initial_token: ${initialToken}<#else># initial_token:</#if>
...
commitlog_directory: ${cassandraHome}/commitlog
...
saved_caches_directory: ${cassandraHome}/saved_caches
...
client_encryption_options:
    enabled:  ${enableSSL!"false"}
    keystore: ${keyStoreLocation!"conf/.keystore"}
    keystore_password: ${keyStorePassword!"cassandra"}
    # require_client_auth: false
    ...
    # algorithm: SunX509
    # store_type: JKS
    # Minimised ciphers to ensure tests don't require unlimited strength JCE files
